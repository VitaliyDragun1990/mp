...
<header id="header">
	<div class="inner">
		...
		<ul class="actions fit small">
			...
			<li><a data-sign-up="google-plus" class="button google-plus fit small icon fa-google-plus">Goolge+</a></li>
		</ul>
	</div>
</header>
<div id="main">
	<section>
		...
		<div class="row">
			<div class="${'8u 12u$(xsmall)'}">
				<p>service, which allows you to share high-resolution photos for <a href="https://creativecommons.org/publicdomain/zero/1.0/" target="_blank">free</a></p>
			</div>
